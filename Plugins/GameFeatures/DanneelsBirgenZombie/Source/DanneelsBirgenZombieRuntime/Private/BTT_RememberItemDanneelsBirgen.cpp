#include "BTT_RememberItemDanneelsBirgen.h"
...
UBTT_RememberItemDanneelsBirgen::UBTT_RememberItemDanneelsBirgen()
{
	NodeName = "Remember Item";
}

EBTNodeResult::Type UBTT_RememberItemDanneelsBirgen::ExecuteTask(UBehaviorTreeComponent& root, uint8* nodeMemory)
{
...
bool UBTT_RememberItemDanneelsBirgen::IsLocationReachable(APawn* Pawn, const FVector& Location) const
{
...
bool UBTT_RememberItemDanneelsBirgen::FindReachableLocationNearItem(APawn* Pawn, const FVector& ItemLocation, FVector& OutLocation) const
{
	if (!Pawn) return false;

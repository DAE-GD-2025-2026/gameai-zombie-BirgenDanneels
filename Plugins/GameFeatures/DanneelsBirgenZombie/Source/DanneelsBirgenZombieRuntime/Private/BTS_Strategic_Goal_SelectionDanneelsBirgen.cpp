#include "BTS_Strategic_Goal_SelectionDanneelsBirgen.h"
...
UBTS_Strategic_Goal_SelectionDanneelsBirgen::UBTS_Strategic_Goal_SelectionDanneelsBirgen()
{
...
void UBTS_Strategic_Goal_SelectionDanneelsBirgen::TickNode(UBehaviorTreeComponent& root, uint8* nodeMemory, float deltaSeconds)
{
	switch (CurrentState)
	{
...
void UBTS_Strategic_Goal_SelectionDanneelsBirgen::ScanTick(UBehaviorTreeComponent& root)
{
    ...
    auto* Perceptor = Survivor->GetComponentByClass<UStudentPerceptorDanneelsBirgen>();
    if (!Perceptor)
        return;
...
void UBTS_Strategic_Goal_SelectionDanneelsBirgen::CommitTick(UBehaviorTreeComponent& root)
{
	UBlackboardComponent* BlackBoard = root.GetBlackboardComponent();
	if ( !BlackBoard)
		return;

#include "BTT_ShootDanneelsBirgen.h"
...
UBTT_ShootDanneelsBirgen::UBTT_ShootDanneelsBirgen()
{
	NodeName = "Shoot";
	bNotifyTaskFinished = true;
}

EBTNodeResult::Type UBTT_ShootDanneelsBirgen::ExecuteTask(UBehaviorTreeComponent& root, uint8* nodeMemory)
{
...
int UBTT_ShootDanneelsBirgen::GetItemSlot(const TArray<ABaseItem*>& Inventory, ABaseItem* SlotItem) const
{

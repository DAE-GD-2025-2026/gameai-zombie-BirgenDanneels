#include "BTT_AimAtTargetDanneelsBirgen.h"
...
UBTT_AimAtTargetDanneelsBirgen::UBTT_AimAtTargetDanneelsBirgen()
{
...
EBTNodeResult::Type UBTT_AimAtTargetDanneelsBirgen::ExecuteTask(UBehaviorTreeComponent& root, uint8* nodeMemory)
{
	return EBTNodeResult::InProgress;
}

void UBTT_AimAtTargetDanneelsBirgen::TickTask(UBehaviorTreeComponent& root, uint8* nodeMemory, float DeltaSeconds)
{

...
void UNeedsComponent::RecalculateNeeds(const ASurvivorPawn* Survivor, UBlackboardComponent* BlackBoard) const
{
...
// Improve this
int UNeedsComponent::GetWeaponNeed(const ASurvivorPawn* Survivor, const EItemType WeaponType) const
{
    int TotalWeapons = 0;
...
int UNeedsComponent::GetMedkitNeed(const ASurvivorPawn* Survivor) const
{
...
int UNeedsComponent::GetFoodNeed(const ASurvivorPawn* Survivor) const
{

#include "BTS_AutoConsumeDanneelsBirgen.h"
...
UBTS_AutoConsumeDanneelsBirgen::UBTS_AutoConsumeDanneelsBirgen()
{
	NodeName = "AutoConsume";
}

void UBTS_AutoConsumeDanneelsBirgen::TickNode(UBehaviorTreeComponent& root, uint8* nodeMemory, float deltaSeconds)
{
...
bool UBTS_AutoConsumeDanneelsBirgen::TryConsumeItem(ASurvivorPawn* Pawn, EItemType Type, int NeededValue)
{
	UInventoryComponent* Inventory = Pawn->GetComponentByClass<UInventoryComponent>();

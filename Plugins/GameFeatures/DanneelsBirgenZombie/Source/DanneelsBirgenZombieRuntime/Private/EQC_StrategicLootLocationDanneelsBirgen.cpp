#include "EQC_StrategicLootLocationDanneelsBirgen.h"
...
void UEnvQueryContext_StrategicLootLocationDanneelsBirgen::ProvideContext(FEnvQueryInstance& QueryInstance, FEnvQueryContextData& ContextData) const
{

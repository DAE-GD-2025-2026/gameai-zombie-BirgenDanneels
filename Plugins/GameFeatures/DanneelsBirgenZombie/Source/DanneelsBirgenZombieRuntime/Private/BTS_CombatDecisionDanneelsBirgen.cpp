#include "BTS_CombatDecisionDanneelsBirgen.h"
...
UBTS_CombatDecisionDanneelsBirgen::UBTS_CombatDecisionDanneelsBirgen()
{
...
void UBTS_CombatDecisionDanneelsBirgen::TickNode(UBehaviorTreeComponent& root, uint8* nodeMemory, float deltaSeconds)
{
...
void UBTS_CombatDecisionDanneelsBirgen::OnCeaseRelevant(UBehaviorTreeComponent& root, uint8* nodeMemory)
{
...
ABaseZombie* UBTS_CombatDecisionDanneelsBirgen::FindBestTarget(const APawn* Pawn) const
{
...
bool UBTS_CombatDecisionDanneelsBirgen::HasLOS(const APawn* Pawn, const ABaseZombie* Target) const
{
...
int UBTS_CombatDecisionDanneelsBirgen::CountZombiesNearTarget(const APawn* Pawn, const ABaseZombie* Target, float Radius) const
{
...
ABaseItem* UBTS_CombatDecisionDanneelsBirgen::ChooseBestWeapon(APawn* Pawn, ABaseZombie* Target, int CloseZombieCount) const
{
	if (!Pawn) return nullptr;

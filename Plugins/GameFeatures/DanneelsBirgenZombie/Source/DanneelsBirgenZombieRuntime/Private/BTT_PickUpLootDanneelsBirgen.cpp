#include "BTT_PickUpLootDanneelsBirgen.h"
#include "Items/BaseItem.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "AIController.h"
#include "Common/InventoryComponent.h"

UBTT_PickUpLootDanneelsBirgen::UBTT_PickUpLootDanneelsBirgen()
{
	NodeName = "Pick Up Loot";
}

EBTNodeResult::Type UBTT_PickUpLootDanneelsBirgen::ExecuteTask(UBehaviorTreeComponent& root, uint8* nodeMemory)
{
...
int UBTT_PickUpLootDanneelsBirgen::GetFreeInventorySlot(const TArray<ABaseItem*>& Inventory) const
{

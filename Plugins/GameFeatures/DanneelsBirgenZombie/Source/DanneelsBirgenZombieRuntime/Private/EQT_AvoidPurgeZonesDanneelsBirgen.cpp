#include "EQT_AvoidPurgeZonesDanneelsBirgen.h"
...
UEnvQueryTest_AvoidPurgeZonesDanneelsBirgen::UEnvQueryTest_AvoidPurgeZonesDanneelsBirgen()
{
...
void UEnvQueryTest_AvoidPurgeZonesDanneelsBirgen::RunTest(FEnvQueryInstance& QueryInstance) const
{
	...
	const UStudentPerceptorDanneelsBirgen* Perceptor = QueryPawn->FindComponentByClass<UStudentPerceptorDanneelsBirgen>();
	if (!Perceptor) return;
...
bool UEnvQueryTest_AvoidPurgeZonesDanneelsBirgen::IsPointInsidePurgeZone(const FVector& Point, const APurgeZone* Zone) const
{
	return FVector::DistSquared2D(Point, Zone->GetActorLocation()) <= FMath::Square(PurgeZoneRadius);
}

bool UEnvQueryTest_AvoidPurgeZonesDanneelsBirgen::PathTouchesForbiddenPurgeZone(const TArray<FVector>& PathPoints, const TArray<APurgeZone*>& PurgeZones, const APurgeZone* StartPurgeZone) const
{

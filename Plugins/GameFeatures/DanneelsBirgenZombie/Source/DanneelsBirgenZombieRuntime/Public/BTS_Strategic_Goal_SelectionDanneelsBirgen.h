...
#include "BTS_Strategic_Goal_SelectionDanneelsBirgen.generated.h"

class ABaseItem;

UCLASS()
class DANNEELSBIRGENZOMBIERUNTIME_API UBTS_Strategic_Goal_SelectionDanneelsBirgen : public UBTService
{
	GENERATED_BODY()

public:
	UBTS_Strategic_Goal_SelectionDanneelsBirgen();

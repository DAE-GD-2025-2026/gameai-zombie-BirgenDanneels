...
#include "BTS_CombatDecisionDanneelsBirgen.generated.h"

class ABaseZombie;
class ABaseItem;

UCLASS()
class DANNEELSBIRGENZOMBIERUNTIME_API UBTS_CombatDecisionDanneelsBirgen : public UBTService
{
	GENERATED_BODY()

public:
	UBTS_CombatDecisionDanneelsBirgen();
